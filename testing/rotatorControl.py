from gPredictPassApprover import rigControl
import serial
import socket
    ...
    try:
        ...
        while True:
            ...
            while True:
                ...
                # Update doppler file
                UL_FREQ_shifted, DL_FREQ_shifted = radsat.getDoppler(145.83e6,435.4e6,updateFiles = True)
                print("UL Dopp = %sHz | DL Dopp = %sHz", (UL_FREQ_shifted, DL_FREQ_shifted))
