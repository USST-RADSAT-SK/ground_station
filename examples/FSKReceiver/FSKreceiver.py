...
class FSKreceiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "FSKreceiver")
        ...
        self.top_grid_layout.addWidget(self._qtgui_sink_x_1_win, 12, 0, 1, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_win, 11, 0, 1, 1)
        ...
        self.osmosdr_source_0.set_gain(rxgain, 0)
    ...
    def set_baud(self, baud):
        self.baud = baud
        self.set_samp_rate(self.baud * self.sps)
        self.qtgui_sink_x_1.set_frequency_range(self.freq, self.baud)
    ...
    def set_rxgain(self, rxgain):
        self.rxgain = rxgain
        self.osmosdr_source_0.set_gain(self.rxgain, 0)
...
def main(top_block_cls=FSKreceiver, options=None):
